...
const translations = {
  ja: {
    ...
    'Delete stored files.': '保存されたファイルを削除します。',
    'NEW GRANT': '新しい権限',
    'Share with a user': 'ユーザーと共有',
    'User account': 'ユーザーアカウント',
    'Enter the exact username': '正確なユーザー名を入力',
    'Usernames are not listed to protect account privacy.': 'アカウントのプライバシーを保護するため、ユーザー一覧は表示されません。',
    ...
    'The maximum number of repositories for this account has been reached.': 'このアカウントで作成できるリポジトリ数の上限に達しました。',
    'The server repository limit has been reached.': 'サーバーのリポジトリ数の上限に達しました。',
